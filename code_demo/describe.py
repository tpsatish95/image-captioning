...
if __name__ == '__main__':
	...
	font = ImageFont.truetype("CaviarDreams.ttf", int(img.size[1]*img.size[0]*0.000050))
	draw.text((10, 10),sentence,(255,255,255),font=font)
	img.save("Output/Captioned_"+sys.argv[2])
	img.show()
	# temp = skimage.io.imread("Output/Captioned_"+sys.argv[2])
	# skimage.io.imshow(temp)
